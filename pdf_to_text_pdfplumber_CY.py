...
# parser.parse_args() busca parámetros que se pasan por una terminal de comandos (como cuando el Pipeline de Databricks ejecuta la tarea)
# args = parser.parse_args() # SE COMENTA PARA ejecutar manualmente como un Notebook
# input_root = args.source_path
# output_root = args.target_path

input_root = "/Volumes/logistics/bronze/raw/cy/pdf/"
output_root = "/Volumes/logistics/bronze/raw/cy/txt_pdfplumber/"
...
print(f"✅ PROCESAMIENTO COMPLETADO EN: {total_duration:.2f} SEGUNDOS")